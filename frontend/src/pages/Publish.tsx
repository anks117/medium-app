        ...
        <div className='flex justify-center w-full mt-10'>
            ...
            <div className='max-w-screen-lg w-full px-10 '>
                ...
                onClick={async()=>{
                 ...
                 type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Publish</button>
            </div>
